...
SCHEMA = {
    "employees" : {"description" : "Employee records including department and salary" ,
    ...
    "products" : {"description" : "Products the company sells, with price and inventory" ,
    ...
    "sales" : {"description" : "Individual sales transactions linking employees to products" ,
